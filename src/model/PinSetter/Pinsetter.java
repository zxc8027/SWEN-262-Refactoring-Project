package model.PinSetter;/*
 * model.PinSetter.Pinsetter.java
 *
 * Version:
 *   $Id$
 *
 * Revisions:
 *   $Log: model.PinSetter.Pinsetter.java,v $
 ...
 *   controller.ControlDesk now runs its own thread and polls for free lanes to assign queue members to
 *
...
public class Pinsetter {
    ...
    /** model.PinSetter.Pinsetter()
     *
     * Constructs a new pinsetter
     *
     * @pre none
     * @post a new pinsetter is created
     * @return model.PinSetter.Pinsetter object
     */
    public Pinsetter(){
        pins = new boolean[10];
        rnd = new Random();

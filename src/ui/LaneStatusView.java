...
import model.Lane.LaneEvent;
import model.Lane.LaneObserver;
...
public class LaneStatusView implements ActionListener, LaneObserver, PinsetterObserver {
     ...
     * the GUI for the lane. model.Lane.Lane name and players will be updated when an event created for this.
    ...
    public LaneStatusView(Lane lane, int laneNum ){
        ...
        viewLane = new JButton("View model.Lane.Lane");
        JPanel viewLanePanel = new JPanel();
        viewLanePanel.setLayout(new FlowLayout());
        viewLane.addActionListener(this);
        viewLanePanel.add(viewLane);

        viewPinSetter = new JButton("model.PinSetter.Pinsetter");
